...
var Lia = function () {
    ...
    (0, _createClass3.default)(Lia, [{
        ...
        value: function _buildImage(_ref) {
            ...
            var opt = this.options;
            var outputPath = this._realpath(opt.image);
        ...
        value: function _outputStyle(result) {
            var opt = this.options;
            var outputPath = this._realpath(opt.style);
        ...
        value: function _renderData(_ref2) {
            ...
            var realpath = this._realpath(_options.image);
            ...
            var items = (0, _keys2.default)(coordinates).map(function (realpath) {
                var _coordinates$realpath = coordinates[realpath];
                var x = _coordinates$realpath.x;
                var y = _coordinates$realpath.y;
                var size = _coordinates$realpath.size;

                var name = _options.prefix + _this._filename(realpath);
                var width = _this._decimal(size.width);
                var height = _this._decimal(size.height);
