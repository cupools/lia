...
var Sprite = function () {
    ...
    (0, _createClass3.default)(Sprite, [{
        ...
        value: function run() {
            ...
            var ret = _child_process2.default.spawnSync('node', [_path2.default.join(__dirname, 'spritesmith.js'), '-sprites', (0, _stringify2.default)(sprites), '-options', (0, _stringify2.default)(opt)], {
                encoding: 'utf8'
            });

            if (ret.stderr) {
                _log2.default.error(ret.stderr);
                return false;
            }
