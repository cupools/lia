...
var Lia = function () {
    ...
    (0, _createClass3.default)(Lia, [{
        ...
        value: function _outputStyle(_ref2) {
            ...
            (0, _keys2.default)(coordinates).map(function (originPath) {
                var payload = coordinates[originPath];
                store.push(_this._render(originPath, payload, {
        ...
        value: function getResource() {
            ...
            return [].concat((0, _toConsumableArray3.default)(new _set2.default(sprites.filter(function (p) {
                return ignore !== _this2._basename(p);
            }).map(function (p) {
                return _this2._resolvePath(p);
            }))));
        }
    }, {
        key: '_getTemplate',
