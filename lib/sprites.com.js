...
var Sprite = function () {
    ...
    _createClass(Sprite, [{
        ...
        value: function run() {
            ...
            var ret = _child_process2.default.execFileSync(_path2.default.resolve(__dirname, 'spritesmith'), ['-sprites', JSON.stringify(sprites)]);
        ...
        key: '_buildStyle',
        value: function _buildStyle(_ref2) {
            ...
            for (var originPath in coordinates) {
                if (coordinates.hasOwnProperty(originPath)) {
                    ...
                    content.push(this._getTmpl(originPath, payload, { totalWidth: totalWidth, totalHeight: totalHeight }));
                }
            }
        ...
        key: '_getTmpl',
        value: function _getTmpl(originPath, _ref5, _ref6) {
            ...
            var destName = this._basename(image);
            var selector = this.options.prefix + this._name(originPath);
